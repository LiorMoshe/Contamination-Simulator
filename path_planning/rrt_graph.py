...
class RRT:
    ...
    def planning(self, animation=False):
        ...
        # Randomize nodes until max iterations.
        for i in range(self.max_iter):
            # Get a random node, 5% of the time this will be the end goal.
            ...
            # Add to the node list if there is no collision.
    ...
    def steer(self, from_node, to_node, extend_length=float("inf")):
        ...
        # Count the length of expansion required, number of steps is decided based on the given path resolution.
